            ...
            <div class="form-princ">
                ...
                <div class="pagina1 movPag">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" id="herramienta" name="herramienta" placeholder="" value="<?= $row['herramienta'] ?>">
                        </div>
                        <div class="campo">
                            <div class="label">Disponibilidad:</div>
                            <input type="text" id="disponibilidad" name="disponibilidad" placeholder="" value="<?= $row['disponibilidad'] ?>">
                        </div>
                        <div class="campo">
                            <div class="label">Fecha Salida</div>
                            <input type="text" id="fecha_alta" name="fecha_alta" placeholder="" value="<?= $row['fecha_alta'] ?>">
                        </div>
                        <div class="campo">
                            <div class="label">Fecha entrada</div>
                            <input type="text" id="fecha_baja" name="fecha_baja" placeholder="" value="<?= $row['fecha_baja'] ?>">
                        </div>
                        <div class="campo">
                            <div class="label">Estado de herramienta</div>
                            <input type="text" id="estado_herramienta" name="estado_herramienta" placeholder="" value="<?= $row['estado_herramienta'] ?>">
                        </div>
