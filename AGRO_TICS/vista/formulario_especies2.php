                ...
                <form action="" method="POST">
                    ...
                    <div class="pagina1 movPag">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" id="nombrecientifico" name="nombrecientifico" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Familia</div>
                            <input type="text" id="familia" name="familia" placeholder="">
                        </div>
                        <div class="campo">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" id="especie" name="especie" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Origen</div>
                            <input type="text" id="origen" name="origen" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Taxonomia</div>
                            <input type="text" id="taxonomia" name="taxonomia" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Raiz</div>
                            <input type="text" id="raiz" name="raiz" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Hojas</div>
                            <input type="text" id="hojas" name="hojas" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Tallo</div>
                            <input type="text" id="tallo" name="tallo" placeholder="">
                        </div>
                        <div class="campo">
                            <div class="label">Inflorescencia</div>
                            <input type="text" id="inflorescencia" name="inflorescencia" placeholder="">
                        </div>
